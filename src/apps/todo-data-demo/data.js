const todoItems = [
  ...
  { title: 'Fix inline editing', completed: true },
  ...
  { title: 'Make a working filter (show: all, open, completed)', completed: false },
  { title: 'Refactor todoApp', completed: false },
  { title: 'Split components into seperate component files', completed: true },
